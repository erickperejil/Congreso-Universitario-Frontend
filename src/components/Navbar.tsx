...
export default function Nav({ options }: NavProps) {
    ...
    // Función para hacer scroll suave al hacer clic en el enlace
                ...
                <div className="relative flex h-14 items-center justify-between">
                    ...
                    <div className="inset-y-0 left-0 flex items-center sm:hidden">
                        <DisclosureButton className="group relative inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-[#30303d] hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-[#F8B133]">
                            <span aria-hidden="true" className="block material-symbols-outlined text-xl group-data-[open]:hidden">
                                menu
                            </span>
                            <span aria-hidden="true" className="hidden material-symbols-outlined cursor-pointer text-xl group-data-[open]:block">
                                close
                            </span>
                        </DisclosureButton>
                    </div>
